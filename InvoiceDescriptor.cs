...
namespace s2industries.ZUGFeRD
{
    ...
    public class InvoiceDescriptor
    {
        ...
        public void AddApplicableTradeTax(decimal taxAmount, decimal basisAmount, decimal percent, TaxTypes typeCode, TaxCategoryCodes? categoryCode = null, decimal allowanceChargeBasisAmount = 0, TaxExemptionReasonCodes? exemptionReasonCode = null, string exemptionReason = null)
        {
            Tax tax = new Tax()
            {
                TaxAmount = taxAmount,
